...
export function Navigation() {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? "glass-morphism" : ""}`}
    >
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="text-2xl font-bold text-neon-blue text-glow">AC</div>
          ...
          <Button
            ...
            className="bg-neon-purple hover:bg-neon-pink text-white neon-border animate-glow"
          >
            Let's Connect
          </Button>
        </div>
